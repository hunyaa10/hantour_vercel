...
const LocationLists = () => {
  ...
  return (
    <SectionWrapper>
      <Container>
        <SectionTitle>Hotels by Location</SectionTitle>
        <SliderWrapper>
          <SliderContainer>
            <Slider {...sliderSettings}>
              {hotelLocationLists.map((location, index) => (
                <div key={`${location.area}-${index}`}>
                  <CardLink to={`/hotel-search?area=${location.area}`}>
                    <CardImage $imageUrl={location.imageURL}>
                      <CardOverlay />
                      <CardTitle>{location.area}</CardTitle>
                    </CardImage>
                  </CardLink>
                </div>
              ))}
